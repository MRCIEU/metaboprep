...
raw_data$sample_data = tibble::as_tibble(raw_data$sample_data); colnames(raw_data$sample_data) = "SamID"
raw_data$feature_data = tibble::as_tibble(raw_data$feature_data); colnames(raw_data$feature_data) = "FeatureID"
raw_data$varexp = raw_data$varexp[,1]

## QC Data
qc_data$metabolite_data = tibble::as_tibble(qc_data$metabolite_data)
qc_data$sample_data = tibble::as_tibble(qc_data$sample_data); colnames(qc_data$sample_data) = "SamID"
qc_data$feature_data = tibble::as_tibble(qc_data$feature_data); colnames(qc_data$feature_data) = "FeatureID"
...
This report provides descriptive information for raw and quality controlled metabolomics data for the project `r project`. The quality control pipeline is as follows (in order):

```{r QC-pipeline-flowdiagram, echo=FALSE, out.width='50%'}
...
(run.cont.power.make.plot.R(mydata = raw_data$metabolite_data))
```
